...
This repo includes the final code for the video on playing video and image sequences using GreenSock's scrollTrigger. Here is the link to the Youtube video:
